...
- A finished follow-up re-measure could go unreported when its push failed. The number is now posted once, as soon as it is known. A seal with no ledger change is pushed as the session's own commit.
